 ...
 * {@link OnSetupProfileFragmentInteractionListener} interface
...
public class SetupProfileFragment extends Fragment {
    ...
    private OnSetupProfileFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSetupProfileFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSetupProfileFragmentInteractionListener) {
            mListener = (OnSetupProfileFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnSetupProfileFragmentInteractionListener {
        // TODO: Update argument type and name
        void onSetupProfileFragmentInteraction(Uri uri);
    }
}
